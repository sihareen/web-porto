                    ...
                    <div key={actualIndex} className="relative">
                      ...
                      >
                        ...
                        <div className="mb-4 flex items-center justify-between">
                          <span className="text-4xl font-black font-mono text-[var(--accent)]">
                            {milestoneNumber}
                          </span>
                        ...
                        {isHovered && (
                          <div className="absolute top-0 left-0 right-0 bg-[var(--surface)] border-2 border-[var(--accent)] p-6 shadow-2xl z-20 min-w-[360px]">
                            <div className="mb-4 flex items-center justify-between">
                            ...
                            <p className="text-xs font-bold uppercase tracking-wider text-[var(--accent)] mb-4">
                              {item.period}
                            </p>

                            <h3 className="text-lg font-bold uppercase tracking-tight text-[var(--primary)] mb-3">
                              {item.title}
                            </h3>

                            {item.company && (
                              <p className="text-base font-semibold text-[var(--secondary)] mb-4">
                                {item.company}
                              </p>
                            )}
